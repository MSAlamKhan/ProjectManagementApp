...
const MenuSelectComponent = ({
    ...
    return (
        <View>
            <View style={styles.Bar}>
                <TouchableOpacity
                    ...
                    style={[
                        styles.MenuBox,
                        {
                            backgroundColor: menu === "first" ? Colors.Main : Colors.IconColor,
                        },
                    ]}
                >
                    <Text
            ...
            <SwipeListView
                data={menu === 'first' ? firstData : menu == 'second' ? secondData : thirdData}
                // keyExtractor={item => item.id.toString()}
                renderItem={({ item }) => {
                    return (
                        <JobCard onPress={() => navigation.navigate('alltask', { type: item.alert})}  menu = {menu} data={item} />
                    );
                }}
                renderHiddenItem={() => (
