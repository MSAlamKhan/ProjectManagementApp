      ...
      <View style={[GlobalStyle.ph20flex]}>
        <View style={{ justifyContent: "center" }}>
          <View>
            ...
            >
              {`We've`} just send you 4 digits code to your email {email} {otp}
            </Text>
          </View>
          ...
          <CodeField
            ...
            renderCell={({ index, symbol, isFocused }) => (
              <View key={index} style={styles.OTPBox}>
                <Text
                  style={[{ color: Colors.Black }, styles.cell]}
          ...
          />
          {time == 0 ? (
            <TouchableOpacity onPress={() => resendOtp()} style={styles.Forgot}>
            ...
            <View style={styles.Forgot}>
              ...
              >
                You can Resend Your OTP in {time}
              </Text>
            </View>
          )}
        </View>
